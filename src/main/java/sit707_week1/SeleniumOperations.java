...
public class SeleniumOperations {
	...
	public static void open_chrome_and_close() {
		...
		//System.setProperty("webdriver.chrome.driver", "C:/Users/Venkata Raghava Nave/AppData/Local/Chromium/Application/chrome.exe");
	...
	public static void open_chrome_loadpage_resize_close() {
		...
		//System.out.println("Hello from < s224099224>, <VENKATA RAGHAVA NAVEEN VEEDHULA>");
		
		// Step 1: Locate chrome driver folder in the local drive.
		System.setProperty("webdriver.chrome.driver", "C:\\Users\\Venkata Raghava Nave\\Downloads\\chromedriver-win64\\chromedriver-win64\\chromedriver.exe");
	    ...
	    sleep(2);
	    System.out.println("Resizing to 640X480");
	    ...
	    sleep(2);
	    System.out.println("Resizing to 1280X960");
		// Sleep a while
		sleep(2);
